...
export default class Initializer {
    ...
    static yes: boolean;
    static init(config_filename: string, yes: boolean, skip_install: boolean, version: string | undefined, skip_framework_detection: boolean, empty: boolean): Promise<void>;
